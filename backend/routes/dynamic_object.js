...
const {getPaginatedDataByObjectName,getUserColumnVisibilitiesByObjectName,createBulkDocumentsOfObjectName, createDocumentOfObjectName,getDataBySearchTermOfObjectName, getAllDataByFilterOfObjectName,updateDocumentOfObjectName,deleteDocumentOfObjectName} = require('../controllers/dynamic_object');
