...
dynamicObjectRouter.get(
  "/:objectName",
  (req, res, next) => {
    authorizeClient([`view:${req.params.objectName}`])(req, res, next);
  },
  getPaginatedDataByObjectName,
);
dynamicObjectRouter.get(
  "/:objectName/column-visibilities",
  (req, res, next) => {
    authorizeClient([`view:${req.params.objectName}`])(req, res, next);
  },
  getUserColumnVisibilitiesByObjectName,
);
dynamicObjectRouter.post(
  "/:objectName/bulk",
  (req, res, next) => {
    authorizeClient([`create:${req.params.objectName}`])(req, res, next);
  },
  createBulkDocumentsOfObjectName,
);
dynamicObjectRouter.post(
...
dynamicObjectRouter.put(
  "/:objectName/update",
  (req, res, next) => {
    authorizeClient([`edit:${req.params.objectName}`])(req, res, next);
  },
  updateDocumentOfObjectName,
);
dynamicObjectRouter.delete(
  "/:objectName/delete",
  (req, res, next) => {
    authorizeClient([`delete:${req.params.objectName}`])(req, res, next);
  },
  deleteDocumentOfObjectName,
);
dynamicObjectRouter.delete(
  "/:objectName/delete/bulk",
  (req, res, next) => {
    authorizeClient([`delete:${req.params.objectName}`])(req, res, next);
  },
  deleteBulkDocumentsOfObjectName,
...
dynamicObjectRouter.get(
  "/:objectName/filter-docs/paginate",
  (req, res, next) => {
    authorizeClient([`view:${req.params.objectName}`])(req, res, next);
  },
  getPaginatedDataWithFiltersByObjectName,
