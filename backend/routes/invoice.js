...
// // Update invoice
invoiceRouter.put('/update', (req,res,next)=>{authorizeClient(["edit:invoices"])(req,res,next)}, updateInvoice);

// Delete invoice
invoiceRouter.delete('/delete', (req,res,next)=>{authorizeClient(["delete:invoices"])(req,res,next)}, deleteInvoice);

invoiceRouter.get('/column-visibilities', (req, res, next) => { authorizeClient([`view:invoices`])(req, res, next) }, getUserColumnVisibilities);
// // Get single invoice
