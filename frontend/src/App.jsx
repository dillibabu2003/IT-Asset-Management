      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute ><MainLayout /></ProtectedRoute>}>
          ...
          <Route path="/users">
            ...
            <Route path="manage" element={<ProtectedComponent requiredPermission="edit:users" redirect={true}><ManageUsers behavior="edit" /></ProtectedComponent>} />
            <Route path="view" element={<ProtectedComponent requiredPermission="view:users" redirect={true}><ManageUsers behavior="view" /> </ProtectedComponent>} />
            <Route path="view/:userId" element={<ProtectedComponent requiredPermission="view:users" redirect={true}>some user with some id in params</ProtectedComponent>} />
          </Route>
