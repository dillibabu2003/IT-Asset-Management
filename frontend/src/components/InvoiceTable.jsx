    ...
    try {
      ...
      if (response.data.success) {
        window.open(
          ...
          "_blank",
          "scrollbars=yes,resizable=yes,top=200,left=500,height=500,width=1000,noopener,noreferrer",
        );
      }
    } catch (error) {
      console.log(error);
        ...
        <Table>
          ...
          <TableBody>
            {sortedDocuments.map((document) => (
              <TableRow key={document.invoice_id} hover>
                {Object.entries(visibleColumns).map(([columnId, isVisible]) => {
                ...
                <TableCell>
                  ...
                  >
                    <IconButton
                      ...
                      color="success"
                      onClick={() =>
                        handleViewInvoice(document.invoice_filename)
                      }
                    >
                  ...
                  <ProtectedComponent
                    requiredPermission={PERMISSIONS.DELETE_INVOICES}
                  >
                    <IconButton
                      size="small"
                      color="error"
